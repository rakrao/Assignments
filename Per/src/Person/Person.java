//This code deals about taking input details of two persons and comparing those two to find who is elder among two 
package Person;
...
Period p;
public Person(String name, int day, int month, int year) { //constructor person is defined with four parameters
	this.name=name;
	this.day=day;
	this.month=month;
	this.year=year;
...
public void olderOne(Person person1, Person person2) //this function help to find older person among two
{
